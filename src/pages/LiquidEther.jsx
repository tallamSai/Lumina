  ...
  useEffect(() => {
    ...
    class CommonClass {
      ...
      init(container) {
        ...
        this.renderer.setPixelRatio(Math.min(this.pixelRatio, 1.5)); // Lower pixel ratio for performance
    ...
    class Simulation {
      constructor(options) {
        this.options = {
          ...
          viscous: 25,
          isBounce: false,
          dt: 0.016, // Optimized dt for smooth performance
          isViscous: true,
          BFECC: true,
          ...options,
        };
      ...
      getFloatType() {
        ...
        // Use HalfFloatType for better performance on mobile devices
